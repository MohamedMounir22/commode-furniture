...
export const translations = {
  ar: {
    ...
    deliveredPage: {
      title: "معرض تسليمات كومود",
      subtitle: "نفخر بكوننا جزءاً من منازلكم. شاهد قطعنا الفنية في واقعها الجديد.",
  ...
  en: {
    ...
    admin: {
      ...
      form: {
        ...
        addProductSubtitle: "Add a product and you'll be redirected after saving.",
        editProductTitle: "Edit Product",
        back: "Back",
        backToProducts: "Back to Products",
        productName: "Product Name",
